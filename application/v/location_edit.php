	...
	<script type="text/javascript">
		...
		function reset() {
			...
			$('#location-email').val("<?= $location->phone; ?>");
			$('#location-phone').val("<?= $location->email; ?>");
		}
		...
		function submit() {
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?= base_url() ?>location/ajax_edit/<?= $location->id; ?>/',
				xhr: function() {
					var percentage = 0;
			...
			<div class="column">
				...
				<div class="form-content">
					<div class="ui form">
						...
						<div class="field">
							<label>Address</label>
							<textarea id="location-address" placeholder="Address.."><?= $location->address; ?></textarea>
						</div>
					</div>
				</div>

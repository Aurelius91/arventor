	...
	<script type="text/javascript">
		...
		function reset() {
			$('#movement-number').val("");
			$('#movement-date').val("<?= $date_display; ?>");
			...
			$('#movement-location-to').val("");
			$('#movement-location-to-selection').dropdown('set selected', "");
		}
		...
		function submit() {
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?= base_url() ?>movement/ajax_add/',
				xhr: function() {
					var percentage = 0;
		...
		<div class="ui stackable one column centered grid">
			<div class="column">
				<div class="ui attached message setting-header">
					<div class="header">Add movement</div>
				</div>
							...
							<div class="field">
								<table class="ui striped selectable celled table" style="border: 1px solid rgba(34, 36, 38, 0.15); border-radius: 0;">
									...
									<tbody id="movement-item-list">
										<tr id="movement-item-list-1" class="movement-product-list" data-number="1">
											<td class="td-icon">
											...
											<td style="text-align: right;">
												<input id="movement-product-quantity-1" type="text" class="movement-item-quantity" data-number="1" placeholder="Quantity..">
											</td>
										</tr>
										<tr>

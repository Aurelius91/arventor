									...
									<tbody id="sale-item-list">
										<? foreach ($sale->arr_sale_item as $key => $sale_item): ?>
											<tr id="sale-item-list-<?= $key + 1; ?>" class="sale-product-list" data-number="<?= $key + 1; ?>">
												...
												<td>
													<div id="sale-product-selection-<?= $key + 1; ?>" class="ui search remote selection dropdown form-input">
												...
												<td class="td-price-quantity" style="text-align: right;">
													<input id="sale-product-price-<?= $key + 1; ?>" type="text" class="sale-item-price" data-number="<?= $key + 1; ?>" placeholder="Price.." style="text-align: right;">
												</td>
												<td class="td-price-quantity" style="text-align: right;">
													<input id="sale-product-quantity-<?= $key + 1; ?>" type="text" class="sale-item-quantity" data-number="<?= $key + 1; ?>" placeholder="Quantity.." style="text-align: right;">
												</td>
												<td class="td-price-quantity" style="text-align: right;">

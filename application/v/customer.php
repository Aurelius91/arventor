							...
							<tr>
								<td class="td-icon">
									<? if (isset($acl['customer']) && $acl['customer']->edit > 0): ?>
										<a onclick="getCustomer('<?= $customer->id; ?>');">
									...
									<? if (isset($acl['customer']) && $acl['customer']->delete > 0): ?>
										<a class="open-modal-warning-delete" data-customer-id="<?= $customer->id; ?>" data-customer-name="<?= $customer->name; ?>" data-customer-updated="<?= $customer->updated; ?>">
											<span class="table-icon">
